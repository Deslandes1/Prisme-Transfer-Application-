...
with st.sidebar:
    ...
    # If you have a logo, place it in assets/logo.png and uncomment below
    # st.image("assets/logo.png", width=120)
    # For now, we use a text-based logo
    st.markdown("""
    <div style='text-align: center;'>
        <div style='font-size: 4rem; background: linear-gradient(135deg, #00209F 0%, #00209F 50%, #D21034 50%, #D21034 100%); 
             -webkit-background-clip: text; -webkit-text-fill-color: transparent; 
             font-weight: 900; display: inline-block; padding: 0 10px;'>
            💸
        </div>
        <div style='font-size: 1.8rem; font-weight: 800; color: #00209F; margin-top: -0.5rem;'>
            Prisme Transfer
        </div>
